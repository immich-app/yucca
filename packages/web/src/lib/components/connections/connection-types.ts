...
export const CONNECTION_TYPES: ConnectionTypeMeta[] = [
  {
    ...
    limitation: 'Added automatically when you connect FUTO Backups from the Immich app; not created here.',
    addable: false,
  },
  {
    type: 'standalone',
    ...
    limitation: 'Added automatically when you connect FUTO Backups from the standalone app; not created here.',
    addable: false,
  },
];
