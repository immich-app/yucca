...
// Resolver discovers the backend S3 endpoint set. Resolve runs at startup and
// every reconcile tick — implementations re-read their source each call (hot
// reload). Elements are full endpoint URLs, e.g. "http://10.0.1.5:80".
