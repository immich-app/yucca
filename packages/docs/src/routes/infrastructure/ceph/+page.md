---
title: Ceph
description: Ansible automation for provisioning, deploying, tuning, hardening and operating the bare-metal Ceph clusters sietch and spice with cephadm
order: 4
---
...
scaffolding are provisioned from `yucca/tf/` (see [Terraform](/infrastructure/terraform)).
...
procedure are in [docs/cluster-profiles.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/cluster-profiles.md).
...
- **Controller (your workstation)**: mise + ansible + 1Password CLI. It reaches
  the sietch nodes over SSH as `ansible-iac` and the spice nodes as `root`.
- **sietch** (Austin DC, `10.10.10.0/24` flat): laurel, lawson and samara, each
  running MON+MGR+OSD+RGW.
- **spice** (Hetzner FSN1-DC24, public `10.40.20.0/23`, cluster `10.40.22.0/23`):
  adelia (bootstrap), curtis, hayley, lizzie and serena run MON+MGR+OSD+RGW; the
  other 43 nodes run OSD+RGW. The ingress VIP `10.40.20.250` (haproxy +
  keepalived) fronts all 48 RGWs.

See [docs/architecture.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/architecture.md) for role dependencies,
...
See [CONTRIBUTING.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/CONTRIBUTING.md) for the full development workflow.
...
| Document                                                                                                       | Audience                                                                                                                                                              |
| -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [CONTRIBUTING.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/CONTRIBUTING.md)                  | Developers -- setup, workflow, conventions                                                                                                                            |
| [docs/architecture.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/architecture.md)        | Developers -- role graph, data flow, design                                                                                                                           |
| [docs/patterns.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/patterns.md)                | Developers -- coding idioms, anti-patterns                                                                                                                            |
| [docs/adding-a-role.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/adding-a-role.md)      | Developers -- role skeleton, conventions                                                                                                                              |
| [docs/adding-a-cluster.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/adding-a-cluster.md) | Developers -- inventory setup, secrets                                                                                                                                |
| [docs/secrets.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/secrets.md)                  | Developers/ops -- 1Password integration                                                                                                                               |
| [docs/naming.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/naming.md)                    | Everyone -- hostname and inventory naming                                                                                                                             |
| [docs/cluster-profiles.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/cluster-profiles.md) | Ops -- per-cluster hosts, SSH, vaults, shape differences                                                                                                              |
| [docs/hardware.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/hardware.md)                | Ops/procurement -- node specs and hardware shapes                                                                                                                     |
| [docs/s3-integration.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/s3-integration.md)    | App developers -- endpoints, boto3, certs                                                                                                                             |
| [docs/security-model.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/security-model.md)    | InfoSec -- encryption, users, firewall                                                                                                                                |
| [docs/capacity-planning.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/capacity-planning.md) | Managers -- costs, formulas, growth                                                                                                                                   |
| [docs/troubleshooting.md](https://github.com/immich-app/yucca/blob/main/ansible/ceph/docs/troubleshooting.md)  | SRE/on-call -- symptom/diagnosis/fix                                                                                                                                  |
| [docs/runbooks/](https://github.com/immich-app/yucca/tree/main/ansible/ceph/docs/runbooks)                     | Ops -- add/replace node, replace disk, triage a dead root filesystem, rotate certs/secrets/SSH/SA token, remote hands, bad-tofu-apply recovery, backup/restore         |
