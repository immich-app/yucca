# Public keys are NOT secret and live in version control; any passwords come
# from variables sourced from 1Password (never committed). Instantiated once per
# VC with that VC's aliased junos provider.
