# cluster-fabric — per-cluster leaf VC pair: server bonds, VLANs + IRB gateways,
# NO-CROSS-VLAN filter, spine uplink. Addressing from fabric-addressing; aliased
# junos provider passed in by the stack.
