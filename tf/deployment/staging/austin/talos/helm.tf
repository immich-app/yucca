# Cilium CNI: nodes stay NotReady until this lands (cni:none in the module);
# same apply, right after bootstrap — one apply yields a Ready cluster.
# KPR → Talos KubePrism localhost:7445. wait=true blocks until agent + operator Ready.
